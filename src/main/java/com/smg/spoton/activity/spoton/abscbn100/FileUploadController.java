...
public class FileUploadController {
    ...
    public void  downloadSpotOn(@RequestParam("file") MultipartFile[] files, HttpServletResponse response) throws IOException {
        ...
        if (files != null && files.length > 1 && files[1] != null) {
            workbooks = ReadFileWriteResultsXLSX.main(files[1], spotsCheck);
        }
